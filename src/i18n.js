...
- Return ONLY the raw JSON array — no markdown fences, no explanation.`,
    ...
    programPlaceholder: "Program / Course",
    semesterLabel: "Semester",
    enrolledLabel: "Currently Enrolled",
    classesLabel: "Classes This Semester",
    addClassPlaceholder: "Add a class…",
    addClass: "Add",
    professorPlaceholder: "Professor (private — never shown publicly)",
    demoPrivacyLabel: "Who can see your academic info?",
    privacyOnlyMe: "Only Me",
    privacyMutuals: "Mutual Followers",
    privacyEveryone: "Everyone",
    professorPrivateNote: "Professor is always private regardless of this setting.",
    profileComplete: "Profile Complete",
    profileIncomplete: "Incomplete profile",
    semesterReminder: "New semester? Update your class list.",
    updateNow: "Update",
    testOrigin: "Test Origin",
    testOriginNote: "Complete your academic profile to auto-fill this.",
    verifyTitle: "Real Exam Verifications",
    verifyBtn: "I took this exam in real life",
    verifyUpdate: "Update my verification",
    verifyPassed: "I passed ✅",
    verifyFailed: "I didn't pass ❌",
    verifySubmit: "Submit",
    verifyNeedProfile: "Complete your academic profile (college, program, semester) to verify this test.",
    verifiedCount: "verified",
    passedCount: "passed",
    passRate: "pass rate",
    verifyMine: "Your result:",
    forgotPassword: "Forgot password?",
    forgotPasswordTitle: "Reset Password",
    forgotPasswordDesc: "Enter your username and we'll send a reset link to your recovery email.",
    sendResetLink: "Send Reset Link",
    resetLinkSent: "If your account has a recovery email, a reset link has been sent. Check your inbox.",
    ...
    recoveryEmailNote: "Used only for password resets. Never shown publicly.",
    backToSignIn: "Back to Sign In",
    usernameOrEmail: "Username or Email",
    heroBadge: "For Nursing Students",
    heroSubtext: "The study platform where nursing students share, practice, and track real exam content — together.",
    heroF1Title: "Practice with Peers",
    heroF1Desc: "Access real exam questions uploaded by nursing students at your college.",
    heroF2Title: "Track Your Progress",
    heroF2Desc: "Monitor accuracy, streaks, and weak areas across every study session.",
    heroF3Title: "Compete & Connect",
    heroF3Desc: "Follow classmates, climb the leaderboard, and study alongside your cohort.",
    heroF4Title: "Verify Real Exams",
    heroF4Desc: "Confirm whether a practice test matched your actual classroom exam.",
    security: "Security",
    ...
    avatarHint: "Tap an emoji to use as your avatar, or leave blank for initials.",
    classNamePlaceholder: "Class name…",
    classProfPlaceholder: "Professor (optional)",
    addClassPair: "Add",
...
- Devuelve SOLO el arreglo JSON sin markdown ni explicaciones.`,
    ...
    earnedLabel: "Obtenido",
    academicProfile: "Perfil Académico",
    collegePlaceholder: "Universidad / Colegio",
    programPlaceholder: "Programa / Curso",
    semesterLabel: "Semestre",
    enrolledLabel: "Actualmente Inscrito",
    classesLabel: "Materias Este Semestre",
    addClassPlaceholder: "Agregar materia…",
    addClass: "Agregar",
    professorPlaceholder: "Profesor (privado — nunca visible públicamente)",
    demoPrivacyLabel: "¿Quién puede ver tu info académica?",
    privacyOnlyMe: "Solo Yo",
    privacyMutuals: "Seguidores Mutuos",
    privacyEveryone: "Todos",
    professorPrivateNote: "El profesor siempre es privado sin importar esta configuración.",
    profileComplete: "Perfil Completo",
    profileIncomplete: "Perfil incompleto",
    semesterReminder: "¿Nuevo semestre? Actualiza tu lista de materias.",
    updateNow: "Actualizar",
    testOrigin: "Origen del Examen",
    testOriginNote: "Completa tu perfil académico para autocompletar esto.",
    verifyTitle: "Verificaciones de Examen Real",
    verifyBtn: "Tomé este examen en la vida real",
    verifyUpdate: "Actualizar mi verificación",
    verifyPassed: "Pasé ✅",
    verifyFailed: "No pasé ❌",
    verifySubmit: "Enviar",
    verifyNeedProfile: "Completa tu perfil académico (universidad, programa, semestre) para verificar.",
    verifiedCount: "verificaron",
    passedCount: "pasaron",
    passRate: "tasa de aprobación",
    verifyMine: "Tu resultado:",
    forgotPassword: "¿Olvidaste tu contraseña?",
    forgotPasswordTitle: "Restablecer Contraseña",
    forgotPasswordDesc: "Ingresa tu usuario y enviaremos un enlace de restablecimiento a tu correo de recuperación.",
    sendResetLink: "Enviar Enlace",
    resetLinkSent: "Si tu cuenta tiene un correo de recuperación, se ha enviado un enlace. Revisa tu bandeja.",
    resetPassword: "Restablecer Contraseña",
    resetPasswordDesc: "Ingresa y confirma tu nueva contraseña.",
    newPassword: "Nueva Contraseña",
    confirmPassword: "Confirmar Contraseña",
    resetSuccess: "¡Contraseña restablecida! Ya puedes iniciar sesión.",
    resetInvalid: "Este enlace es inválido o ha expirado.",
    recoveryEmail: "Correo de Recuperación",
    recoveryEmailPlaceholder: "Correo de recuperación (opcional)",
    recoveryEmailNote: "Solo para restablecer contraseña. Nunca visible públicamente.",
    backToSignIn: "Volver al Inicio",
    usernameOrEmail: "Usuario o Correo",
    heroBadge: "Para Estudiantes de Enfermería",
    heroSubtext: "La plataforma de estudio donde los estudiantes de enfermería comparten, practican y verifican contenido de exámenes reales — juntos.",
    heroF1Title: "Practica con Compañeros",
    heroF1Desc: "Accede a preguntas reales subidas por estudiantes de tu universidad.",
    heroF2Title: "Monitorea tu Progreso",
    heroF2Desc: "Observa tu precisión, rachas y áreas débiles en cada sesión de estudio.",
    heroF3Title: "Compite y Conéctate",
    heroF3Desc: "Sigue a compañeros, sube en el ranking y estudia junto a tu cohorte.",
    heroF4Title: "Verifica Exámenes Reales",
    heroF4Desc: "Confirma si un examen de práctica coincidió con el examen real de tu clase.",
    security: "Seguridad",
    ...
    avatarHint: "Toca un emoji para usarlo como avatar, o déjalo en blanco para las iniciales.",
    classNamePlaceholder: "Nombre de la materia…",
    classProfPlaceholder: "Profesor (opcional)",
    addClassPair: "Agregar",
